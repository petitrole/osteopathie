...
<div id="bloc-footer-info" class="col-xs-8 col-sm-4  pull-right">
  <?php  $block = module_invoke('block', 'block_view', '2');
    print render($block['content']);
  ?>
  <div id="social-icon" class="col-xs-8 col-sm-4 col-md-8  ">
    ...
    <div class='col-xs-8 col-sm-4 col-md-6 contact-element name'>
  ...
  <div class=''>
    <div class='col-xs-8 col-sm-4 col-md-6 contact-element'>
  ...
  <div class=''>
    ...
    <?php else : ?>
      <div class='col-xs-8 col-sm-4 col-md-8 contact-error div-error-vide'>
